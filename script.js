...
const categoriesData = [
    ...
    },
    {
        ...
        questions: [
            ...
            { points: 40, q: "Цифровой след принято делить на два основных типа: активный и пассивный. Активный след — это то, что вы публикуете осознанно (посты, фото, комментарии).\n\nА что из перечисленного является примером пассивного цифрового следа?", a: "Данные о вашем IP-адресе и типе устройства, собранные сайтом.\n\nПассивный цифровой след формируется без вашего прямого участия или явного намерения опубликовать контент. Это данные, которые собираются в фоновом режиме: история поиска, cookie-файлы, модель вашего телефона, IP-адрес и геолокация, которые фиксируют серверы, пока вы просто просматриваете страницы. Остальные варианты (A, C, D) требуют осознанного действия пользователя (нажатия кнопки «отправить» или «загрузить»), поэтому относятся к активному следу." },
