...
const categoriesData = [
    {
        ...
        questions: [
            { points: 100, q: "Какая логическая операция истинна только тогда, когда истинны все входящие в нее простые высказывания", a: "Конъюнкция, Логическое умножение, И" },
            { points: 200, q: "Вычислите устно значение выражения: (1∨0)∧0.", a: "Ложь (0)" },
            { points: 300, q: "В таблице истинности для выражения из 4 переменных (A, B, C, D) заполнено несколько строк. Сколько ВСЕГО строк должно быть в этой таблице?", a: "16 строк" }
        ]
    },
    {
        name: "Татары",
        questions: [
            { points: 100, q: "Это сладкое блюдо из обжаренных во фритюре кусочков теста, щедро политых медовым сиропом, является визитной карточкой татарской кухни. Без него не обходится ни одна свадьба. Назовите его.", a: "Чак-чак." },
            { points: 200, q: "Этот национальный мужской головной убор представляет собой небольшую шапочку, часто украшенную богатой вышивкой бисером или золотой нитью. В Татарстане её носят и в повседневной жизни, и по праздникам.", a: "Тюбетейка (тубэтэй)." },
            { points: 300, q: "Самый известный и массовый татарский национальный праздник, название которого переводится как «Праздник плуга». Он знаменует окончание весенних полевых работ.", a: "Сабантуй." }
        ]
    },
    {
        name: "Удмурты",
        questions: [
            { points: 100, q: "Считается, что именно из удмуртского (и коми) языка в русский пришло название этого популярного мясного блюда. По-удмуртски «пель» — это ухо, а «нянь» — хлеб. Что это за «хлебное ухо»?", a: "Пельмень (пельмени)." },
            { points: 200, q: "Удмуртию неофициально называют мировой столицей людей с этой внешней особенностью. Ежегодно в Ижевске даже проходит фестиваль, посвященный таким людям. О какой особенности внешности речь?", a: "Рыжий цвет волос." },
            { points: 300, q: "В 2012 году удмуртская культура прогремела на весь мир благодаря этому музыкальному коллективу из небольшого села, который занял второе место на конкурсе «Евровидение», исполнив песню «Party for Everybody» на удмуртском и английском языках.", a: "«Бурановские бабушки»." },
        ]
    },
];
